            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="./images/avatar.jpg" alt="Remarkable Digital Products" class="img-fluid w-100 rounded" width="372px">
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="./images/avatar.jpg" alt="<span>Remarkable Digital Products</span>" class="img-fluid w-100 rounded" width="372px">
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
...
<section class="projects-section hiro-section" id="works">
    <div class="container">
        <h2 class="section-title career-section-title">Our Works</h2>
        <div class="row">
